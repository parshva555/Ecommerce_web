    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-row pt-4 font-size-16 font-mukta">
                    <div class="col">
            ...
            <div class="col-sm-6 py-5">
                ...
                <table class="my-3">
                    ...
                    <tr class="font-rale font-size-14">
                        <td>You Save:</td>
                        <td><span class="font-size-16 text-danger">$<?php echo 162 - $item['item_price']?></span></td>
                    </tr>
                </table>
                <!---    !product price       -->
